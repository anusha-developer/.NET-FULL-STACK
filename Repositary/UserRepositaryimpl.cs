    ...
    public User GetUserById(long user_id)
    {
        ...
        public User UpdateUser(long user_id, User user)
        {
            ...
            try
            {
                con = DbConnections.CreateConnection();
                con.Open();
                SqlCommand cmd = new SqlCommand("Update BMS_Tbl_USERS  SET  Username = '" + user.Username + "', Email = '" + user.Email + "', Password = '" + user.Password + "', Mobilenumber = '" + user.Mobilenumber + "', Gender = '" + user.Gender + "',  Dob = '" + user.Dob + "', Address = '" + user.Address + "', Created_date = '" + user.Created_date + "', Updated_date = '" + user.Updated_date + "',Login_time = '" + user.Login_time + "',Logout_time = '" + user.Logout_time + "' WHERE Userid =" + user_id, con);
